...
namespace AuthSystem.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        {
            //prevent logged in users from viewing registration page
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new AuthSystemUser { UserName = Input.Email, Email = Input.Email,FirstName =Input.FirstName, LastName = Input.LastName };
